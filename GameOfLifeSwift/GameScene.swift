...
class GameScene: SKScene {
    ...
    let _populationLabel:SKLabelNode = SKLabelNode(text: "Población")
   
    let _generationLabel:SKLabelNode = SKLabelNode(text: "Generación")
    ...
    override func didMoveToView(view: SKView) {
        ...
        let microscope = SKSpriteNode(imageNamed: "mexico.png")
        ...
        _populationLabel.fontColor = UIColor.whiteColor()
        ...
        _populationValueLabel.fontColor = UIColor.whiteColor()
        ...
        _generationLabel.fontColor = UIColor.whiteColor()
        ...
        _generationValueLabel.fontColor = UIColor.whiteColor()
